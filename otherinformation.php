...
<body style="background-image:url(img/acara/other_inform.jpg)">
  <!-- Logo -->
 <?php include('components/logo.php'); ?>
  ...
  <div class="container-fluid navigasi">
    <div class="align-self-center" style="position: absolute; top:750px;">
      <a href="#"><img src="img/title/title_otherinform.png" class="img-link"></a>
    </div>
  </div>
  ...
  <div class="container-fluid d-flex justify-content-center" style="position: absolute; top: 3325px;">
    ...
    <a href="index.php"><img src="img/kanan.png" class="img-link" ></i></a>
  </div>
